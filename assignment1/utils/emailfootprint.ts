export class EmailFootprint {
    private readonly STANDARD_CO2_PER_EMAIL: number = 0.004;
    private readonly ATTACHMENT_CO2_PER_EMAIL: number = 0.05;
    private readonly SPAM_CO2_PER_EMAIL: number = 0.0003;
